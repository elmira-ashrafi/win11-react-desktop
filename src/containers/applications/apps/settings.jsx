                            ...
                            <div key={i} className={e.type}>
                              <div className="left">
                                ...
                                <div className="column_device">
                                  <p className="device_name">Elmira Ashrafi</p>
                                  <p className="device_model">Frontend Developer</p>
                                  <p className="device_rename">github.com/elmira-ashrafi</p>
                                </div>
                              </div>
                              <div className="right">
                                <div className="column">
                                  <img
                                    src="img/asset/microsoft.svg"
                                    height={20}
                                    alt=""
                                  />
                                  <p>
