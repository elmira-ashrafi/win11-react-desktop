...
class JioSaavn {
  constructor() {
    ...
    this.dfdata = [
      {
        id: "raindrop-rhythms",
        album: "Raindrop Rhythms",
        albumArt: "img/asset/raindrop.jpeg",
        name: "Raindrop Rhythms",
        artist: "Elmira Ashrafi",
        duration: 0,
        src: "music/Raindrop Rhythms.mp3",
      },
    ];
  ...
  getDefault() {
    return Promise.resolve(this.dfdata);
  }
