...
const Home = ({ tab, action, sid, paused }) => {
  ...
  return (
    <div className="spHome mt-12">
      <div className="sitem w-full mb-8">
        <div className="text-gray-100 font-bold">My Music</div>
        <div className="w-full h-px mt-2"></div>
        <div className="w-full pt-1 -ml-3">
          <div className="w-max flex">
            <div className="scard pt-3 px-3" style={{ "--rot1": "210deg" }}>
              <Image
                src="img/asset/raindrop.jpeg"
                ext
                w={200}
                err="/img/asset/mixdef.jpg"
                onClick={action}
                click="song"
                payload={'"raindrop-rhythms"'}
              />
              <div className="sover p-4 nopt"></div>
              {sid != "raindrop-rhythms" || paused ? (
                <div className="fplay">
                  <div className="tria"></div>
                </div>
              ) : (
                <div className="fpause">
                  <div className="fbars"></div>
                </div>
              )}
