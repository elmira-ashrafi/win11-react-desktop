...
export const WnTerminal = () => {
  ...
  const [stack, setStack] = useState([
    ...
    "",
    "Welcome to Elmira Ashrafi's Portfolio Terminal!",
    "Type 'about' to learn more. Type 'help' for all commands.",
    "",
  ]);
  const [pwd, setPwd] = useState("C:\\Users\\Elmira");
  ...
  const cmdTool = async (cmd) => {
    ...
    if (type == "echo") {
    ...
    } else if (type == "blue" || type == "whoami" || type == "about") {
      tmpStack.push("Elmira Ashrafi — Frontend Developer");
      tmpStack.push("Email    : elmiraashrafiiii@gmail.com");
      tmpStack.push("GitHub   : https://github.com/elmira-ashrafi");
      tmpStack.push("Skills   : React, Redux, JavaScript, HTML, CSS, Vite, Tailwind CSS");
      tmpStack.push("");
      tmpStack.push("Projects : Win11 React Desktop Portfolio");
    } else if (type == "ver") {
      tmpStack.push("OS [Version 10.0.22000.51]");
    } else if (type == "systeminfo") {
      var dvInfo = [
        "Host Name:                 ELMIRA-ASHRAFI",
        "OS Name:                   Portfolio OS — Win11React Edition",
        "OS Version:                10.0.22000 N/A Build 22000.51",
        "OS Manufacturer:           github.com/elmira-ashrafi",
        "OS Configuration:          Portfolio Workstation",
        "OS Build Type:             Multiprocessor Free",
        "Registered Owner:          Elmira Ashrafi",
        "Registered Organization:   Frontend Developer",
        "Product ID:                REACT-REDUX-VITE-PWA",
      ];
      ...
      var helpArr = [
        ...
        "ABOUT          Show portfolio owner info and contact details.",
