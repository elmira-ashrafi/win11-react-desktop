      ...
      <div id="page">
        <div id="container">
          ...
          <div id="details">
            <div id="qr">
              <div id="image">
                <img src="img/asset/qr.png" alt="QR Code" />
              </div>
            </div>
            <div id="stopcode">
              <h4>
                ...
                <br />{" "}
                <a href="mailto:elmiraashrafiiii@gmail.com">
                  elmiraashrafiiii@gmail.com
                </a>{" "}
              </h4>
              <h5>
...
function App() {
  ...
  return (
    <div className="App">
      <div className="orient-warn">
        <svg width="64" height="64" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
          <rect x="5" y="2" width="14" height="20" rx="2" />
          <path d="M12 18h.01" />
        </svg>
        <h2>Rotate Your Device</h2>
        <p>For the best experience, please use this site in landscape (horizontal) mode.</p>
      </div>
